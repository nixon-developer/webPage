      ...
      <div className="pricing__container container grid">
        <div className="pricing__item card card-one">
          ...
          <h3 className="pricing__price">
            <span>₹</span> 39 <em>Hour</em>
          </h3>

          <p className="pricing__description">
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ipsum,
            eaque dolorum ratione inventore cum molestiae eum commodi voluptatem
            temporibus? Nostrum tenetur ea dolor repellat sequi laborum illo
            odio at natus.
          </p>
          ...
          <a href="javascript" className="btn pricing__btn text-cs">
            Start Project
        ...
        <div className="pricing__item-wrapper">
          ...
          <div className="pricing__item card card-one">
            ...
            <h3 className="pricing__price">
              <span>₹</span> 259 <em>Week</em>
            </h3>

            <p className="pricing__description">
              Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ipsum,
              eaque dolorum ratione inventore cum molestiae eum commodi
              voluptatem temporibus? Nostrum tenetur ea dolor repellat sequi
              laborum illo odio at natus.
            </p>
